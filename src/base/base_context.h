// -- This header is a slightly modified version of Ryan Fleury's "context cracking" header.
// (base_ctx_crack.h). 
...
// -- Build parameters defined in the build script (build.bat)
